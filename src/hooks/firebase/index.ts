...
import { getDocs, collection, QuerySnapshot, doc, getDoc, query, where, QueryFieldFilterConstraint } from "firebase/firestore"
...
export const useSignOut = () => {
    ...
    return useMutation({ mutationFn: logOut, onSuccess: () => toast({ title: "You have logged out successfully" }) })
}

export const useCollection = <T>(collectionName: string, filters?: URLSearchParams) => {
