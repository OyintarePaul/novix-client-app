...
const ApartmentFilters = () => {
    ...
    return (
            ...
            <div className="flex gap-4 my-6">
                <Select onValueChange={(value: string) => handleSelectChange("price", value)}>
                    <SelectTrigger>
                ...
                <Select onValueChange={(value: string) => handleSelectChange("type", value)}>
                    <SelectTrigger>
                ...
                <Select onValueChange={(value: string) => handleSelectChange("has_water", value)}>
                    <SelectTrigger>
                ...
                <Select onValueChange={(value: string) => handleSelectChange("has_light", value)}>
                    <SelectTrigger>
